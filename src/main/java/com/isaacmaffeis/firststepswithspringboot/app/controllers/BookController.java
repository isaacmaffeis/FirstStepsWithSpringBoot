...
public class BookController {
    ...
    public ResponseEntity<BookDto> partialUpdateBook(
            // Annotazione che lega la variabile di percorso "{isbn}" al parametro del metodo "isbn"
            @PathVariable("isbn") String isbn,
            // Annotazione che lega il corpo della richiesta HTTP al parametro del metodo "bookDto"
